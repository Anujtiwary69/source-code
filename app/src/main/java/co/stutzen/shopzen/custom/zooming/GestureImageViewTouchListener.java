...
public class GestureImageViewTouchListener implements OnTouchListener {
	...
	public GestureImageViewTouchListener(final GestureImageView image, int displayWidth, int displayHeight, Context con) {
		super();
        this.context = con;
		this.image = image;
	...
	protected void handleScale(float scale, float x, float y) {
		...
		currentScale = scale;
		Log.i("tttt", currentScale + "=" + minScale + "=" + maxScale);
